...
{
    handler.getParam("/stereo/norlab_basler_camera_driver_node_compressed/startup_user_set", parameters["startup_user_set"]);
    handler.getParam("/stereo/norlab_basler_camera_driver_node_compressed/image_encoding", parameters["image_encoding"]);
    handler.getParam("/stereo/norlab_basler_camera_driver_node_compressed/camera1_calibration_url", parameters["camera1_calibration_url"]);
    handler.getParam("/stereo/norlab_basler_camera_driver_node_compressed/camera2_calibration_url", parameters["camera2_calibration_url"]);
    handler.getParam("/stereo/norlab_basler_camera_driver_node_compressed/gain", gain);
}
...
{
    ros::init(argc, argv, "norlab_basler_camera_driver_node_compressed");
    ros::NodeHandle nh;
